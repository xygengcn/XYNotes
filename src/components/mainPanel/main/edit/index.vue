...
<template>
    <div class="EditPanel">
        <div class="EditHeader">
            <input type="text" class="title" :value="activeNoteText.title" @blur="editTitle" placeholder="写下笔记标题" :style="titleStyle" />
            <em class="tag">正在编辑</em>
        </div>
        <div class="EditContain">
            <textarea id="EditArea" class="EditArea" :value="activeNoteText.text" @blur="editNote" @input="autoSave" @keydown="handleEvent" placeholder="直接开始输入" ref="EditArea" @contextmenu.prevent="context_menu" @click="isContextMenu =false" :style="contentStyle"></textarea>
