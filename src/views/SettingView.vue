        ...
        <page-view :title="'设置'" :icon="'el-icon-setting'">
            <div class="setting-container">
                <ul>
                    <li>
                        <label>本地存储</label>
                        <el-switch v-model="configs.isLocalStorage" active-color="#13ce66" @change="saveConfig">
                        </el-switch>
                    </li>
                    <li>
                        <label>网络存储</label>
                        <el-switch v-model="configs.isWebStorage" active-color="#13ce66" @change="saveConfig">
                        </el-switch>
                    </li>
                    <li>
                        <label>黑暗主题</label>
